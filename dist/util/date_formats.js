...
exports.timezoneAbbreviationMap = exports.dateTime = exports.timeZoneFormate = exports.LocalFormate = exports.DateFormate = void 0;
const moment_1 = __importDefault(require("moment"));
const moment_timezone_1 = __importDefault(require("moment-timezone"));
const DateFormate = (startDate, endDate, time = false) => {
    if (startDate && endDate) {
        if ((0, moment_1.default)(startDate).format("MMM Do") !== (0, moment_1.default)(endDate).format("MMM Do")) {
            if ((0, moment_1.default)(startDate).format("YYYY") !== (0, moment_1.default)(endDate).format("YYYY")) {
                return `${(0, moment_1.default)(startDate).format("MMM D YYYY")} - ${(0, moment_1.default)(endDate).format("MMM D YYYY")}`;
            }
            else if ((0, moment_1.default)(startDate).format("MMM") === (0, moment_1.default)(endDate).format("MMM")) {
                return `${(0, moment_1.default)(startDate).format("MMM D")} - ${(0, moment_1.default)(endDate).format("D, YYYY")}`;
            }
            else {
                return `${(0, moment_1.default)(startDate).format("MMM D")} - ${(0, moment_1.default)(endDate).format("MMM D, YYYY")}`;
            }
        }
        else {
            return `${(0, moment_1.default)(startDate).format("MMM Do YYYY")}`;
        }
    }
    else if (time && startDate) {
        return `${(0, moment_1.default)(startDate).format("MMM D YYYY, h:mm A")}`;
    }
    else if (startDate) {
        return `${(0, moment_1.default)(startDate).format("MMM D YYYY")}`;
    }
    else {
        return "";
    }
...
const LocalFormate = (date, timeZone) => {
    const systemTimeZone = moment_timezone_1.default.tz.guess();
    const utcDate = date;
    const convertedDate = (0, moment_timezone_1.default)(utcDate).tz(timeZone || systemTimeZone);
    return convertedDate.format("YYYY-MM-DDTHH:mm:ss");
};
exports.LocalFormate = LocalFormate;
...
const timeZoneFormate = (date, timeZone) => {
    ...
    const customName = exports.timezoneAbbreviationMap[timeZone || systemTimeZone] || "";
    return hasNumber(abbreviation) ? customName : abbreviation;
};
exports.timeZoneFormate = timeZoneFormate;
const dateTime = () => __awaiter(void 0, void 0, void 0, function* () {
    return new Date().toISOString();
});
exports.dateTime = dateTime;
exports.timezoneAbbreviationMap = {
    "Africa/Abidjan": "GMT",
    "Africa/Accra": "GMT",
