...
exports.default = (io) => {
    ...
    v1version.on("connection", (socket) => {
        ...
        socket.on("setSocketId", (data) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                data = Object.assign(Object.assign({}, data), { socket_id: socket.id, user_id: socket.user._id.toString() });
        ...
        socket.on("disconnect", () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                const disconnect_user = yield (0, connect_1.disconnectSocket)(disconnectData, io);
        ...
        socket.on("createRoom", (data) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                const { ln = "en" } = data;
                i18n_1.default.setLocale(ln);
                socket.join(createRoomData.data._id);
        ...
        socket.on("sendMessage", (data) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                data = Object.assign(Object.assign({}, data), { sender_id: socket.user._id.toString() });
                ...
                if (newMessage.success) {
                    ...
                    const senderChatListData = yield (0, chat_2.updatedChatRoomData)({
                    ...
                    const receiverChatListData = yield (0, chat_2.updatedChatRoomData)({
            ...
            try {
                ...
                if (editMessageData.success) {
                    ...
                    if (editMessageData.data.isLastMessage) {
                        const senderChatListData = yield (0, chat_2.updatedChatRoomData)({
                            user_id: editMessageData.data
                                .sender_id,
                            chat_room_id: editMessageData.data
                                .chat_room_id,
                        });
                        v1version
                            .to(editMessageData.data.sender_id)
                            .emit("updatedChatRoomData", senderChatListData);
                        const receiverChatListData = yield (0, chat_2.updatedChatRoomData)({
                            user_id: editMessageData.data
                                .receiver_id,
                        ...
                        v1version
                            .to(editMessageData.data.receiver_id)
                            .emit("updatedChatRoomData", receiverChatListData);
                    }
                }
                else {
        ...
        socket.on("deleteMessage", (data) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                if (deleteMessageData.success) {
                    ...
                    const userChatListData = yield (0, chat_2.updatedChatRoomData)({
                        user_id: data.user_id,
                        chat_room_id: data.chat_room_id,
                    });
                    v1version
        ...
        socket.on("deleteMessageForEveryOne", (data) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                if (deleteMessageForEveryOneData.success) {
                    v1version.to(data.chat_room_id);
                    const senderChatListData = yield (0, chat_2.updatedChatRoomData)({
                        user_id: data.sender_id,
                        chat_room_id: data.chat_room_id,
                    });
                ...
                console.log("deleteMessageForEveryOne Error ON:", error instanceof Error ? error.message : String(error));
                yield (0, response_functions_1.socketErrorRes)(i18n_1.default.__("Something went wrong!"));
            }
        }));
