...
const addContent = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const find_content = yield (0, user_function_1.findContentByType)(
        content_type,
      );
      if (find_content) {
        yield (0, response_functions_1.errorRes)(
          res,
          res.__("The content already exists."),
        );
        return;
      }
      const insert_data = {
      ...
      const create_content = yield index_1.app_contents.create(insert_data);
      yield (0, response_functions_1.successRes)(
        res,
...
const editContent = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      yield index_1.app_contents.findByIdAndUpdate(
        {
          _id: content_id,
        },
        {
      ...
      const find_updated_content = yield (0, user_function_1.findContent)(
        content_id,
      );
      yield (0, response_functions_1.successRes)(
        res,
...
const getContent = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { ln } = req.body;
      i18n_1.default.setLocale(req, ln);
      const find_content = yield index_1.app_contents.find({
        is_deleted: false,
      });
      if (!find_content) {
        yield (0, response_functions_1.errorRes)(
