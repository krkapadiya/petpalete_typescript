...
// import { IUserRequest } from "./community.controller";
...
//     }
//     const insert_data: Record<string, any> = {
//       device_token,
//       device_type,
//       address,
//     };
...
//         if (found && "_id" in found) find_user = found as IUser;
//       } else if (social_id) {
...
//       });
//       await guests.deleteMany({ device_token, device_type });
//       const user_album = await findUserAlbum(find_user._id as string);
//       const res_data = {
//         ...find_user.toObject(),
//         token,
...
//       "otp" in find_user &&
//       (find_user as any).otp === otp.toString()
//     ) {
//       const update_data = {
//         otp: null,
//       };
...
//       album = (req.files as any).album;
//       thumbnail = (req.files as any).thumbnail;
//     } else {
//       album = undefined;
//       thumbnail = undefined;
//     }
...
//           await successRes(
//             res,
//             res.__("User media uploaded successfully."),
//             add_albums,
//           );
//           return;
//         } else {
//           await errorRes(res, res.__("User thumbnail media upload failed."));
//           return;
//         }
//       } else {
//         const user_image_path = `${folder_name}/` + res_upload_file.file_name;
...
//       }
//     } else {
//       await errorRes(res, res.__("User media upload failed."));
//       return;
//     }
//   } catch (error) {
//     console.log("Error : ", error);
...
//         (userAlbum as any).album_path as string,
//       );
//       if ((userAlbum as any).album_type === "video") {
//         await removeMediaFromS3Bucket(
//           (userAlbum as any).album_thumbnail as string,
//         );
//       }
...
//     if (!find_user || typeof find_user !== 'object' || !('_id' in find_user) || !('_doc' in find_user)) {
//       await errorRes(res, res.__("User not found."));
//       return;
//     }
...
//     await successRes(
//       res,
//       res.__("All media uploaded successfully."),
//       uploadedFiles,
//     );
//     return;
//   } catch (error) {
...
//       const deviceTokenData = await findDeviceToken(String(userObjectId));
//       if (
//         !find_pet ||
