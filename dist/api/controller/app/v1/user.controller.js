...
const signUp = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const res_data = Object.assign(Object.assign({}, create_user.toObject()), { token: token, device_token: session.device_token, device_type: session.device_type, user_profile: null });
...
const signIn = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (isSocial) {
            ...
            yield model_guests_1.guests.deleteMany({ device_token, device_type });
            const user_album = yield (0, user_function_1.findUserAlbum)(find_user._id);
...
const resetPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (mobile_number) {
            ...
            yield model_users_1.users.updateOne({ _id: find_user._id }, { $set: update_data });
            yield (0, response_functions_1.successRes)(res, res.__(`Your password has been updated successfully.`), []);
            return;
        }
    }
...
const uploadMedia = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const res_upload_file = yield (0, bucket_manager_1.uploadMediaIntoS3Bucket)(album, folder_name, content_type);
        if (res_upload_file.status) {
            if (thumbnail) {
                const folder_name_thumbnail = "video_thumbnail";
                const content_type_thumbnail = thumbnail.type;
                const res_upload_thumbnail_file = yield (0, bucket_manager_1.uploadMediaIntoS3Bucket)(thumbnail, folder_name_thumbnail, content_type_thumbnail);
                if (res_upload_thumbnail_file.status) {
                    ...
                    const add_albums = yield model_user_albums_1.user_albums.create(fileData);
                    ...
                    yield (0, response_functions_1.successRes)(res, res.__("User media uploaded successfully."), add_albums);
                    return;
                }
                else {
                    yield (0, response_functions_1.errorRes)(res, res.__("User thumbnail media upload failed."));
                    return;
                }
            }
            else {
            ...
            yield (0, response_functions_1.errorRes)(res, res.__("User media upload failed."));
            return;
        }
    }
    catch (error) {
...
const addReview = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (newReview) {
            ...
            let noti_image = (process.env.BUCKET_URL +
                userAlbumData);
...
const userReviewList = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let result_count = yield model_user_reviews_1.user_reviews.countDocuments({
...
const uploadSocketMedia = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { album_type, ln } = req.body;
        let album, thumbnail;
        if (req.files && !Array.isArray(req.files)) {
        ...
        yield (0, response_functions_1.successRes)(res, res.__("All media uploaded successfully."), uploadedFiles);
        return;
    }
    catch (error) {
        console.log("Error : ", error);
...
const addPayment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (newPayment) {
            ...
            const deviceTokenData = yield (0, user_function_1.findDeviceToken)(String(userObjectId));
            if (!find_pet ||
            ...
            yield model_notifications_1.notifications.create({
                ...
                receiver_id: userObjectId,
                noti_title: noti_title,
                noti_msg: `Your pet "pet_name" is now live and visible to others!`,
                noti_for: noti_for,
                pet_id: find_pet._id,
            });
            if (Array.isArray(deviceTokenData) && deviceTokenData.length > 0) {
