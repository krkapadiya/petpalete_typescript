...
service_router.post("/add_service", auth_1.userAuth, multipartMiddleware, (0, validation_1.validateRequest)(service_dto_1.addServiceDto), (req, res) => (0, service_controller_1.addService)(req, res));
...
service_router.post("/upload_service_media", auth_1.userAuth, multipartMiddleware, (0, validation_1.validateRequest)(service_dto_1.uploadServiceMediaDto), (req, res) => (0, service_controller_1.uploadServiceMedia)(req, res));
