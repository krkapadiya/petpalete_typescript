...
const community_detail_route_1 = __importDefault(require("./community_detail.route"));
const faqs_route_1 = __importDefault(require("./faqs.route"));
const pet_detail_route_1 = __importDefault(require("./pet_detail.route"));
const service_detail_route_1 = __importDefault(require("./service_detail.route"));
...
admin_router.use("/community_detail", community_detail_route_1.default);
admin_router.use("/faq", faqs_route_1.default);
admin_router.use("/pet_detail", pet_detail_route_1.default);
admin_router.use("/service_detail", service_detail_route_1.default);
